...
# Otherwise radon.multilevel.nopred.bug believes it's in Ch16, not 12
this.dir <- dirname(parent.frame(2)$ofile)
setwd(this.dir)

mlm.radon.nopred <- openbugs (radon.data, radon.inits, radon.parameters,  n.chains=3, "radon.multilevel.nopred.bug")
