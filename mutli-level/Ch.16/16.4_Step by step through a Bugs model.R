...
source("../Ch.12/12.2_Partial pooling with no predictors.R") # where data was cleaned
...
radon.bugs.1 <- openbugs (radon.data, radon.inits, radon.parameters, "radon.1.bug",
    n.chains=3, n.iter=500)

# Plot Figure 16.2
radon.1.noburnin <- openbugs (radon.data, radon.inits, radon.parameters, "radon.1.bug", n.chains=3, n.iter=500, n.burnin=0)
par (mar=c(5,5,3,2)+.1)
