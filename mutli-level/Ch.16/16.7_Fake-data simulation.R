...
radon.2 <- openbugs (radon.data, radon.inits, radon.parameters, "radon.2.bug",n.chains=3, n.iter=500)
...
radon.2.fake <- openbugs (radon.data, radon.inits, radon.parameters, "radon.2.bug",n.chains=3, n.iter=500)
